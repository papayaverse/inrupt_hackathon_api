        ...
        if((thirdPartyPref == "true")){ 
            ...
            const GreenPapayaContract = await sdk.deploy({
                ...
                params: {
                  name: "Green papaya NFT for sharing data of " + username + " generated by interacting with " + companyName,
                  symbol: 'GPPYA',
                  baseURI: metadataFileUrl,
                  contractURI: metadataFileUrl,
                  maxSupply: 100,
                  price: '0.0001',
                  maxTokenRequest: 1,
                },
            ...
            return res.send("<p> Data of " + username + " generated by interacting with " + companyName + " is now shared via NFT at " + GreenPapayaContract.contractAddress + ".</p>");
        }
    }
    else {
        return res.send("<p>Not logged in.</p>")
